# -*- coding: utf-8 -*-
"""
Created on Sat Jun 12 20:41:51 2021
...
G.add_nodes_from([('12', {'label': 'Kalinic', 'position': 'goalkeeper'}),
                  ...
                  ('15', {'label': 'Bradarić', 'position': 'defender'}),
                  ...
                  ('20', {'label': 'Ivanušec', 'position': 'midfielder'}),
                  ('21', {'label': 'Kramarić', 'position': 'striker'}),
                  ('22', {'label': 'Budimmir', 'position': 'striker'}),
                  ])

G.add_edges_from([('1','12')],
                  type='goalkeeper')

G.add_edges_from([('12', '13'), ('12', '14'), ('13', '15'), ('14', '16'),('13', '17'),
                  ('14', '17'),('15', '17'),('16', '17'),('17', '18'), ('17', '19'),
                  ('18', '19'), ('18', '20'),('19', '20'),('20', '21'),('20', '22'), ('21', '22')],
                  type='bench')
